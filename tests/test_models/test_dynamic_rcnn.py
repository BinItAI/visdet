...
def test_dynamic_rcnn_forward_backward():
        ...
        train_cfg=dict(
            ...
            rcnn=dict(
                ...
                dynamic_rcnn=dict(
                    iou_topk=75,
                    beta_topk=10,
                    update_iter_interval=1,  # update every iteration for testing
                    initial_iou=0.4,
                    initial_beta=1.0,
                ),
                pos_weight=-1,
    ...
    # Run multiple iterations to test hyperparameter updates
    for _ in range(3):
    ...
    print("Dynamic R-CNN forward/backward passed and hyperparameters updated!")


if __name__ == "__main__":
    test_dynamic_rcnn_forward_backward()
