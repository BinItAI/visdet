...
def test_gfl_forward_backward():
    model_cfg = dict(
        ...
        bbox_head=dict(
            ...
            loss_qfl=dict(type="QualityFocalLoss", use_sigmoid=True, beta=2.0, loss_weight=1.0),
    ...
    print("GFL forward and backward tests passed!")


if __name__ == "__main__":
    test_gfl_forward_backward()
