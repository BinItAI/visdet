...
from visdet.engine.registry import VISBACKENDS, VISUALIZERS
from visdet.engine.structures import BaseDataElement
from visdet.engine.utils import ManagerMixin, is_seq_of
from visdet.engine.visualization.utils import (
    check_type,
...
from visdet.engine.visualization.vis_backend import BaseVisBackend
