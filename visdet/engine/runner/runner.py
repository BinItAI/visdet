...
from visdet.engine.dist import (
    broadcast,
    get_dist_info,
    get_rank,
    get_world_size,
...
from visdet.engine.evaluator import Evaluator
from visdet.engine.fileio import FileClient, join_path
from visdet.engine.hooks import Hook
from visdet.engine.logging import MessageHub, MMLogger, print_log
from visdet.engine.model import (
    MMDistributedDataParallel,
    convert_sync_batchnorm,
    is_model_wrapper,
    revert_sync_batchnorm,
)
from visdet.engine.model.efficient_conv_bn_eval import turn_on_efficient_conv_bn_eval
...
from visdet.engine.registry import (
    DATA_SAMPLERS,
    DATASETS,
    EVALUATOR,
    FUNCTIONS,
...
from visdet.engine.utils import apply_to, get_git_hash, is_seq_of
...
class Runner:
    ...
    def _check_scheduler_cfg(self, param_scheduler: dict | list | _ParamScheduler | None) -> None:
        ...
        Examples:
            ...
            >>> from visdet.engine.optim import MultiStepLR
