...
from visdet.engine.dist import broadcast, get_dist_info, infer_launcher, is_distributed
from visdet.engine.logging import MMLogger
from visdet.engine.model.wrappers import is_model_wrapper
from visdet.engine.registry import MODELS, OPTIM_WRAPPERS, PARAM_SCHEDULERS
from visdet.engine.utils import digit_version
from visdet.engine.utils.dl_utils import TORCH_VERSION, collect_env, set_multi_processing

if TYPE_CHECKING:
    from visdet.engine.optim import (
        BaseOptimWrapper,
        OptimWrapperDict,
        _ParamScheduler,
        build_optim_wrapper,
...
class BaseStrategy(metaclass=ABCMeta):
    ...
    def _set_randomness(
        ...
        Args:
            ...
            deterministic (bool): Whether to set the deterministic option for
                ...
                more details.
        """
        from visdet.engine.runner import set_random_seed
    ...
    def build_optim_wrapper(
        ...
        if isinstance(optim_wrapper, dict | ConfigDict | Config):
            ...
            if optimizer is not None or "constructor" in optim_wrapper:
                ...
                from visdet.engine.optim import build_optim_wrapper
    ...
    def _build_param_scheduler(
        ...
        for scheduler in schedulers:
            from visdet.engine.optim import _ParamScheduler
    ...
    def model_state_dict(self) -> dict[str, Any]:
        ...
        from visdet.engine.runner import weights_to_cpu
    ...
    def load_or_resume(
        ...
        *,
        ...
        """
        from visdet.engine.runner import find_latest_checkpoint
