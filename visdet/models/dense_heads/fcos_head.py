...
class FCOSHead(AnchorFreeHead):
    ...
    def __init__(
        ...
        num_classes: int,
        in_channels: int,
        regress_ranges: tuple = ((-1, 64), (64, 128), (128, 256), (256, 512), (512, INF)),
    ...
    def get_targets(self, points: list[Tensor], gt_bboxes_list: list[Tensor], gt_labels_list: list[Tensor]) -> tuple:
