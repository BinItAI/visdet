...
from visdet.engine.model import BaseModule, bias_init_with_prob, constant_init, normal_init
from visdet.engine.structures import InstanceData
from visdet.models.dense_heads.rtmdet_head import RTMDetHead
...
from visdet.structures.bbox import cat_boxes, distance2bbox, get_box_tensor, get_box_wh, scale_boxes
...
class RTMDetInsHead(RTMDetHead):
    ...
    def loss_mask_by_feat(
        self, mask_feats: Tensor, flatten_kernels: Tensor, sampling_results_list: list, batch_gt_instances: InstanceList
    ) -> Tensor:
