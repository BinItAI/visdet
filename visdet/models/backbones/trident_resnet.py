...
class TridentBottleneck(Bottleneck):
    """Trident BottleBlock for TridentResNet."""
...
class TridentResNet(ResNet):
    """Trident ResNet backbone.

    Args:
        num_branch (int): Number of branches in TridentNet.
        test_branch_idx (int): The branch index for testing. -1 means use all
            branches.
        trident_dilations (tuple[int]): Dilations for each branch.
    """
    ...
    def __init__(self, depth, num_branch, test_branch_idx, trident_dilations, **kwargs):
        ...
        self.res_layers[last_stage_idx] = layer_name
