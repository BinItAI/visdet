...
"""Backward compatibility for visdet.core.anchor -> prior_generators."""
...
# Stubs for classes not in minimal build
...
class SSDAnchorGenerator:
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "SSDAnchorGenerator is not available in the minimal visdet build. This is SSD-specific."
        )
...
class YOLOAnchorGenerator:
    ...
    def __init__(self, *args, **kwargs):
        raise NotImplementedError(
            "YOLOAnchorGenerator is not available in the minimal visdet build. This is YOLO-specific."
        )
